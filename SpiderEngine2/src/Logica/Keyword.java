...
public class Keyword implements Comparable<Keyword> {
    ...
    private ListaCircularDoble<String> _urlReferencia = new ListaCircularDoble();
    ...
    public ListaCircularDoble<String> getUrlReferencia() {
        return _urlReferencia;
    }

    public void setUrlReferencia(ListaCircularDoble<String> _urlReferencia) {
        this._urlReferencia = _urlReferencia;
    }
    ...
    public Object getListaKeywords() {
